...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe("images",async ()=>{
    ...
    before(async ()=>{
      result = await decentragram.uploadImage(hash,"image desciption",{from : author});
    ...
    it("creates images",async ()=>{
      ...
      // await decentragram.uploadImage(hash,"description",{from : author}).should.be.rejected;
    ...
    it("lists images",async ()=>{
      ...
      assert.equal(image.description,"image desciption");
    })
